    ...
    return(
        <div className="col-10" style={{backgroundColor:"rgb(0,0,20)",height:"100vh"}}>
                ...
                <div className="col-4 offset-1 " style={{height: "30%"}} >
                    <a href="https://hard-hitting-appeal.000webhostapp.com" >
                        <div className="m-2 cardsStyle " style={card1Style}>
                            <p className="fs-5" style={pStyle}>todoList</p>
                        </div>
                    </a>
                </div>
            ...
            <div className="col-12 d-flex">
                <div className="col-4 offset-1  " style={{height: "30%",marginTop: "50px"}} >
                ...
                <div className="col-4 offset-2  " style={{height: "30%",marginTop: "50px"}} >
                    <a href="https://game1-rock.netlify.app" >
                        <div className="m-2 cardsStyle" style={card4Style}>
                            <p className="fs-5" style={pStyle}>rock-paper-scissor</p>
                        </div>
                    </a>
                </div>
            </div>
